...
export { T as bal_timeinput } from './timeinput-3539f6c5.js';
//! moment.js
//! version : 2.27.0
...
function deProcessRelativeTime(num, withoutSuffix, key) {
    var format = {
...
var Datepicker = /** @class */ (function () {
    function class_1(hostRef) {
         ...
         */
        this.filter = function (_) { return true; };
        /**
         * Callback to format or modify a changed value pefore display.
         */
        this.formatLabel = function (_) { return _; };
    }
    class_1.prototype.valueWatcher = function (newValue) {
        ...
        this.selectedDate = hooks(newValue, Datepicker.FORMAT);
        this.pointerDate = hooks(newValue, Datepicker.FORMAT);
    };
    class_1.prototype.componentWillLoad = function () {
        hooks.locale(this.language);
        if (this.value) {
            this.isPristine = false;
            this.selectedDate = hooks(this.value, Datepicker.FORMAT);
            this.pointerDate = hooks(this.value, Datepicker.FORMAT);
        }
        if (!this.minYear) {
            this.minYear = hooks(this.now).subtract(100, "years").year().toString();
        }
        if (!this.maxYear) {
            this.maxYear = hooks(this.now).add(100, "years").year().toString();
        }
    };
    /**
    ...
    class_1.prototype.open = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.dropDownElement.open()];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    class_1.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.dropDownElement.close()];
                    case 1:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    Object.defineProperty(class_1.prototype, "weekdays", {
        get: function () {
            var arr = hooks.weekdaysMin();
            arr.push(arr.shift());
            return arr;
        },
        enumerable: false,
    ...
    Object.defineProperty(class_1.prototype, "years", {
        get: function () {
            var years = [];
            for (var year = parseInt(this.minYear, 10); year <= parseInt(this.maxYear, 10); year++) {
                years.push(year);
            }
            return years;
        },
    ...
    Object.defineProperty(class_1.prototype, "parsedMaxDate", {
        get: function () {
            return hooks(this.maxDate, Datepicker.FORMAT).startOf("day");
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(class_1.prototype, "parsedMinDate", {
        get: function () {
            return hooks(this.minDate, Datepicker.FORMAT).startOf("day");
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(class_1.prototype, "firstDateOfBox", {
        get: function () {
            return hooks(this.pointerDate).startOf("month").startOf("isoWeek");
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(class_1.prototype, "calendarGrid", {
        get: function () {
            var weekDatePointer = this.firstDateOfBox;
            var dayDatePointer = this.firstDateOfBox;
            var calendar = [];
            do {
                var row = [];
                do {
                    row = __spreadArrays(row, [{
                            date: hooks(dayDatePointer),
                    ...
                    dayDatePointer = hooks(dayDatePointer.add(1, "days"));
                } while (weekDatePointer.isSame(dayDatePointer, "week"));
                calendar = __spreadArrays(calendar, [row]);
                weekDatePointer = hooks(weekDatePointer.add(1, "weeks"));
    ...
    class_1.prototype.previousMonth = function () {
        this.pointerDate = hooks(this.pointerDate.subtract(1, "months"));
    };
    class_1.prototype.nextMonth = function () {
        this.pointerDate = hooks(this.pointerDate.add(1, "months"));
    };
    class_1.prototype.handleYearSelect = function (event) {
        this.pointerDate = hooks(this.pointerDate.year(event.target.value));
    };
    class_1.prototype.handleMonthSelect = function (event) {
        this.pointerDate = hooks(this.pointerDate.month(parseInt(event.target.value, 10)));
    };
    class_1.prototype.selectDate = function (cell) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(!cell.isDisabled && !cell.isOutdated)) return [3 /*break*/, 2];
                        this.isPristine = false;
                        this.selectedDate = hooks(cell.date);
                        this.pointerDate = hooks(cell.date);
                        ...
                        if (!this.closeOnSelect) return [3 /*break*/, 2];
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("div", { class: "datepicker control" }, h("bal-dropdown", { expanded: true, fixed: false, inverted: this.inverted, value: { value: this.value, label: this.formatLabel(this.value) }, readonly: true, disabled: this.disabled, placeholder: this.placeholder, onBalBlur: this.balBlur.emit.bind(this), triggerIcon: "date", ref: function (el) { return _this.dropDownElement = el; } }, h("div", { class: "datepicker-popup" }, h("header", { class: "datepicker-header" }, h("div", { class: "pagination field is-centered" }, h("a", { role: "button", onClick: function () { return _this.previousMonth(); }, class: "pagination-previous" }, h("bal-icon", { name: "nav-go-left", size: "large" })), h("a", { role: "button", onClick: function () { return _this.nextMonth(); }, class: "pagination-next" }, h("bal-icon", { name: "nav-go-right", size: "large" })), h("div", { class: "pagination-list" }, h("div", { class: "field has-addons" }, h("div", { class: "control month-select" }, h("span", { class: "select" }, h("select", { onInput: function (event) { return _this.handleMonthSelect(event); } }, hooks.months().map(function (month, index) { return h("option", { value: index, selected: _this.pointerDate.month() === index }, month); })))), h("div", { class: "control year-select" }, h("span", { class: "select" }, h("select", { onInput: function (event) { return _this.handleYearSelect(event); } }, this.years.map(function (year) { return h("option", { value: year, selected: _this.pointerDate.year() === year }, year); })))))))), h("div", { class: "datepicker-content" }, h("section", { class: "datepicker-table" }, h("header", { class: "datepicker-header" }, this.weekdays.map(function (weekday) { return h("div", { class: "datepicker-cell" }, weekday); })), h("div", { class: "datepicker-body" }, this.calendarGrid.map(function (row) { return h("div", { class: "datepicker-row" }, row.map(function (cell) { return h("div", { onClick: function () { return _this.selectDate(cell); }, "data-date": cell.dateString, class: [
                "datepicker-cell",
