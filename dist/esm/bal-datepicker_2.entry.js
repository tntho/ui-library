...
const Datepicker = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "datepicker control" }, h("bal-dropdown", { expanded: true, fixed: false, inverted: this.inverted, value: { value: this.value, label: this.formatLabel(this.value) }, readonly: true, disabled: this.disabled, placeholder: this.placeholder, onBalBlur: this.balBlur.emit.bind(this), triggerIcon: "date", ref: el => this.dropDownElement = el }, h("div", { class: "datepicker-popup" }, h("header", { class: "datepicker-header" }, h("div", { class: "pagination field is-centered" }, h("a", { role: "button", onClick: () => this.previousMonth(), class: "pagination-previous" }, h("bal-icon", { name: "nav-go-left", size: "large" })), h("a", { role: "button", onClick: () => this.nextMonth(), class: "pagination-next" }, h("bal-icon", { name: "nav-go-right", size: "large" })), h("div", { class: "pagination-list" }, h("div", { class: "field has-addons" }, h("div", { class: "control month-select" }, h("span", { class: "select" }, h("select", { onInput: (event) => this.handleMonthSelect(event) }, hooks.months().map((month, index) => h("option", { value: index, selected: this.pointerDate.month() === index }, month))))), h("div", { class: "control year-select" }, h("span", { class: "select" }, h("select", { onInput: (event) => this.handleYearSelect(event) }, this.years.map((year) => h("option", { value: year, selected: this.pointerDate.year() === year }, year))))))))), h("div", { class: "datepicker-content" }, h("section", { class: "datepicker-table" }, h("header", { class: "datepicker-header" }, this.weekdays.map((weekday) => h("div", { class: "datepicker-cell" }, weekday))), h("div", { class: "datepicker-body" }, this.calendarGrid.map(row => h("div", { class: "datepicker-row" }, row.map(cell => h("div", { onClick: () => this.selectDate(cell), "data-date": cell.dateString, class: [
                "datepicker-cell",
