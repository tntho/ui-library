...
const Datepicker = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "datepicker control" }, index.h("bal-dropdown", { expanded: true, fixed: false, inverted: this.inverted, value: { value: this.value, label: this.formatLabel(this.value) }, readonly: true, disabled: this.disabled, placeholder: this.placeholder, onBalBlur: this.balBlur.emit.bind(this), triggerIcon: "date", ref: el => this.dropDownElement = el }, index.h("div", { class: "datepicker-popup" }, index.h("header", { class: "datepicker-header" }, index.h("div", { class: "pagination field is-centered" }, index.h("a", { role: "button", onClick: () => this.previousMonth(), class: "pagination-previous" }, index.h("bal-icon", { name: "nav-go-left", size: "large" })), index.h("a", { role: "button", onClick: () => this.nextMonth(), class: "pagination-next" }, index.h("bal-icon", { name: "nav-go-right", size: "large" })), index.h("div", { class: "pagination-list" }, index.h("div", { class: "field has-addons" }, index.h("div", { class: "control month-select" }, index.h("span", { class: "select" }, index.h("select", { onInput: (event) => this.handleMonthSelect(event) }, hooks.months().map((month, index$1) => index.h("option", { value: index$1, selected: this.pointerDate.month() === index$1 }, month))))), index.h("div", { class: "control year-select" }, index.h("span", { class: "select" }, index.h("select", { onInput: (event) => this.handleYearSelect(event) }, this.years.map((year) => index.h("option", { value: year, selected: this.pointerDate.year() === year }, year))))))))), index.h("div", { class: "datepicker-content" }, index.h("section", { class: "datepicker-table" }, index.h("header", { class: "datepicker-header" }, this.weekdays.map((weekday) => index.h("div", { class: "datepicker-cell" }, weekday))), index.h("div", { class: "datepicker-body" }, this.calendarGrid.map(row => index.h("div", { class: "datepicker-row" }, row.map(cell => index.h("div", { onClick: () => this.selectDate(cell), "data-date": cell.dateString, class: [
                "datepicker-cell",
            ...
            ].join(" ") }, cell.label)))))), index.h("slot", null)))))));
    }
...
exports.bal_timeinput = timeinput.Timeinput;
exports.bal_datepicker = Datepicker;
