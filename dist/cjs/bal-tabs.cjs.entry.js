...
const Tabs = class {
    constructor(hostRef) {
        ...
        this.tabsDidChange = index.createEvent(this, "balTabsDidChange", 7);
        this.tabsOptions = [];
        /**
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: [
            ...
            ].join(" ") }, index.h("ul", null, this.tabsOptions.map((tab) => (index.h("li", { class: [
                tab.active ? "is-active" : "",
                tab.disabled ? "is-disabled" : "",
            ].join(" ") }, index.h("a", { onClick: () => this.onSelectTab(tab) }, tab.label), index.h("span", { class: "bubble", style: !tab.hasBubble && { display: "none" } })))), index.h("li", { class: "is-right" }, index.h("slot", { name: "action" })))), index.h("slot", null)));
    }
    get element() { return index.getElement(this); }
};
Tabs.style = tabsCss;

exports.bal_tabs = Tabs;
