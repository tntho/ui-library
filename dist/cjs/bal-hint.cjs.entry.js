...
const Hint = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { role: "button", class: "bal-hint-icon", onClick: () => this.toggle() }, index.h("span", null, "i")), this.isActive ? (index.h("div", { class: "bal-hint-content" }, index.h("slot", null), index.h("div", { class: "buttons is-row-reverse" }, index.h("bal-button", { type: "is-info", outlined: true, inverted: true, onClick: () => this.close() }, this.closeLabel)))) : ("")));
    }
