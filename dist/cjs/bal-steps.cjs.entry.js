...
const Steps = class {
    constructor(hostRef) {
        ...
        this.stepsDidChange = index.createEvent(this, "balStepsDidChange", 7);
        this.stepOptions = [];
    }
    /**
     * Select a step.
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: ["tabs is-fullwidth"].join(" ") }, index.h("ul", null, this.stepOptions.map((step, index$1) => (index.h("li", { class: [
                step.active ? "is-active" : "",
                step.disabled ? "is-disabled" : "",
            ].join(" ") }, index.h("a", { onClick: () => this.onSelectStep(step) }, index.h("span", { class: "step-index" }, index.h("span", null, index$1 + 1)), index.h("span", { class: "step-label" }, step.label)), index.h("span", { class: "bubble", style: !step.hasBubble && { display: "none" } })))))), index.h("slot", null)));
    }
