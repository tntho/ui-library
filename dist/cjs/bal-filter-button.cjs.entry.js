...
const FilterButton = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("bal-button", { type: "is-info", dense: true, outlined: true, "is-active": this.isActive, onClick: () => this.toggle() }, index.h("div", { class: "filter-button-inner" }, index.h("div", { class: "bal-checkbox" }, index.h("input", { type: "checkbox", checked: this.isActive }), index.h("label", null, index.h("slot", null)))))));
    }
...
exports.bal_filter_button = FilterButton;
