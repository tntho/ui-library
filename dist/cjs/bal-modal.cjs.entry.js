...
const Modal = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: [
            ...
            ].join(" ") }, index.h("div", { class: "modal-background" }), index.h("div", { class: [
                "modal-card box",
                this.card ? "" : "no-border",
            ].join(" ") }, index.h("header", { class: "modal-card-head" }, index.h("p", { class: "modal-card-title" }, index.h("slot", { name: "head" }))), index.h("section", { class: "modal-card-body" }, index.h("slot", null)), index.h("footer", { class: "modal-card-foot" }, index.h("div", { class: "modal-card-foot-container" }, index.h("slot", { name: "foot" })))))));
    }
};
