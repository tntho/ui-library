...
const Pagination = class {
    ...
    renderEllipsisElement() {
        return index.h("li", null, index.h("span", { class: "pagination-ellipsis" }, "\u2026"));
    }
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("nav", { class: "pagination is-centered", role: "navigation", "aria-label": "pagination" }, index.h("button", { class: "pagination-previous", disabled: this._value < 2, onClick: () => this.previous() }, index.h("bal-icon", { name: "nav-go-left-no-padding", size: "small" })), index.h("button", { class: "pagination-next", disabled: this._value === this.totalPages, onClick: () => this.next() }, index.h("bal-icon", { name: "nav-go-right-no-padding", size: "small" })), index.h("ul", { class: "pagination-list" }, items))));
    }
