...
const Timeinput = class {
    constructor(hostRef) {
        ...
        this.balTimeinputChange = index.createEvent(this, "balTimeinputChange", 7);
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: [
            ...
            ].join(" ") }, index.h("button", { class: "stepper-btn", onMouseDown: () => this.repeatOnHold(() => this.incHour()), onMouseUp: () => this.onMouseLeafOrUp(), onMouseLeave: () => this.onMouseLeafOrUp(), disabled: this.disabled || this.hour >= this.maxHour, tabindex: "-1" }, index.h("svg", { width: "15px", height: "10px", version: "1.1" }, index.h("g", { "stroke-width": "3.25", fill: "none", stroke: this.inverted ? "#ffffff" : "#003399" }, index.h("polyline", { points: "2,8 7.5,2 13,8" })))), index.h("select", { class: "input time-box", onBlur: this.balBlur.emit.bind(this), onChange: this.onHourChange.bind(this), disabled: this.disabled }, index.h("option", { value: "", disabled: true, selected: this.hour === undefined }, "--"), this.hourOptions.map(hourOption => index.h("option", { selected: hourOption.value === Timeinput.formatTimeBoxValue(this.hour), disabled: hourOption.disabled, value: hourOption.value }, hourOption.value))), index.h("button", { class: "stepper-btn", onMouseDown: () => this.repeatOnHold(() => this.decHour()), onMouseUp: () => this.onMouseLeafOrUp(), onMouseLeave: () => this.onMouseLeafOrUp(), disabled: this.disabled || this.hour <= this.minHour || this.hour === undefined, tabindex: "-1" }, index.h("svg", { width: "15px", height: "10px", version: "1.1" }, index.h("g", { "stroke-width": "3.25", fill: "none", stroke: this.inverted ? "#ffffff" : "#003399" }, index.h("polyline", { points: "2,2 7.5,8 13,2" }))))), index.h("div", { class: [
                "time-divider",
                this.inverted ? "is-inverted" : ""
            ].join(" ") }), index.h("div", { class: "stepper" }, index.h("button", { class: "stepper-btn", onMouseDown: () => this.repeatOnHold(() => this.incMinute()), onMouseUp: () => this.onMouseLeafOrUp(), onMouseLeave: () => this.onMouseLeafOrUp(), disabled: this.disabled || this.minute >= this.currentMaxMinute, tabindex: "-1" }, index.h("svg", { width: "15px", height: "10px", version: "1.1" }, index.h("g", { "stroke-width": "3.25", fill: "none", stroke: this.inverted ? "#ffffff" : "#003399" }, index.h("polyline", { points: "2,8 7.5,2 13,8" })))), index.h("select", { class: "time-box", onBlur: this.balBlur.emit.bind(this), onChange: this.onMinuteChange.bind(this), disabled: this.disabled }, index.h("option", { value: "", disabled: true, selected: this.minute === undefined }, "--"), this.minuteOptions.map(minuteOption => index.h("option", { selected: minuteOption.value === Timeinput.formatTimeBoxValue(this.minute), disabled: minuteOption.disabled, value: minuteOption.value }, minuteOption.value))), index.h("button", { class: "stepper-btn", onMouseDown: () => this.repeatOnHold(() => this.decMinute()), onMouseUp: () => this.onMouseLeafOrUp(), onMouseLeave: () => this.onMouseLeafOrUp(), disabled: this.disabled || this.minute <= this.currentMinMinute || this.minute === undefined, tabindex: "-1" }, index.h("svg", { width: "15px", height: "10px", version: "1.1" }, index.h("g", { "stroke-width": "3.25", fill: "none", stroke: this.inverted ? "#ffffff" : "#003399" }, index.h("polyline", { points: "2,2 7.5,8 13,2" })))))));
    }
